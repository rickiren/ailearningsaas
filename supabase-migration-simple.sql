-- Simplified Supabase Migration for AI Learning Path SaaS
-- This version removes authentication dependencies for initial setup
...
-- Grant necessary permissions (without RLS for now)
